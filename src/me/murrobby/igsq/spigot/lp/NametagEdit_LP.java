...
{	
	...
	private void NametagUpdater() 
	{
		...
		for (Player player : Bukkit.getOnlinePlayers())
		{
			...
			NametagEdit.getApi().setNametag(player,Common_Spigot.chatFormatter(nametagPrefixes.get(Common_LP.GetRank(player))),nametagSuffixes.get(getHighestSubRank(player)));
		}
