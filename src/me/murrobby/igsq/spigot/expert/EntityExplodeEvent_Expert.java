...
import me.murrobby.igsq.spigot.BlockCluster;
import me.murrobby.igsq.spigot.Common;
import me.murrobby.igsq.spigot.YamlWrapper;


public class EntityExplodeEvent_Expert implements Listener
{
	public EntityExplodeEvent_Expert()
	{
		Bukkit.getPluginManager().registerEvents(this, Common.spigot);
	}
	
	@EventHandler
	public void EntityExplode_Expert(org.bukkit.event.entity.EntityExplodeEvent event) 
	{
